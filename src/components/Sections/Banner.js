        ...
        <div className="px-5">
          <div className="flex gap-12">
            <div className="relative inline-block hidden h-[180px] w-[150px] md:h-[200px] md:w-[180px] lg:h-[39vh] lg:w-[15vw] md:block">
              <div className="absolute inset-0 bg-gradient-to-br from-lavender-700 to-lavender-400 rounded-xl transform -translate-x-4 translate-y-4" />
            ...
            <div className="animate-slide-in lg:ml-5 mr-5">
              ...
              <ul className="list-disc md:text-left font-medium leading-tight md:leading-normal text-gray-700 pt-[5px] list-outside px-5 md:pl-5 text-lg lg:text-[1.3rem] md:max-w-[55vw] lg:max-w-[45vw]">
                ...
                <li className="pt-3">
                  Strong understanding of business strategy and process analysis
                </li>
                <li className="pt-3">
                  Prioritizes Agile and Lean Six Sigma methodologies
                </li>
              </ul>
              <div className="flex gap-3  sm:justify-start text-md md:text-xl leading-tight md:leading-normal mb-5">
                <a href="#portfolio">
                  <button className="bg-gradient-to-br from-lavender-700 to-lavender-400 hover:from-lavender-800 hover:to-lavender-600 text-white h-auto w-auto py-2 px-2 md:py-3 md:px-5 font-bold rounded-lg mt-5 border-1 border-[#DDE7DF]">
                    View my Portfolio
                  </button>
                </a>
